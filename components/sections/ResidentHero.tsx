  ...
  return (
    <div className=" bg-white font-sans flex flex-col max-container">
      ...
      <main className=" flex-1 flex items-center justify-center relative overflow-hidden">
        ...
        {/* <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-primary-50 rounded-full blur-3xl opacity-60"></div>
        <div className="absolute bottom-[-10%] right-[-5%] w-120 h-120 bg-primary-100 rounded-full blur-3xl opacity-40"></div> */}
        ...
        <div className="w-full  px-6 sm:px-8 lg:px-12 py-16 md:py-24 flex flex-col md:flex-row items-center relative ">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-start gap-6 pr-0 md:pr-10 lg:pr-16">
            ...
            <p className="text-lg sm:text-xl text-slate-600 leading-relaxed max-w-lg italic font-medium border-l-4 border-primary-400 pl-4">
              "Kaagapay sa Pag-unlad, Serbisyo para sa Bawat Mamamayan, Tapat at Maasahan"
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-4">
              <button className="group flex items-center justify-center gap-2 bg-primary-600 hover:bg-primary-700 text-white px-8 py-4 rounded-xl font-semibold shadow-lg shadow-primary-600/30 transition-all duration-300 hover:-translate-y-0.5">
                Get in touch
                <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="flex items-center justify-center px-8 py-4 rounded-xl font-semibold text-slate-700 bg-white border-2 border-slate-200 hover:border-primary-200 hover:bg-primary-50 transition-all duration-300">
                View Features
              </button>
            </div>
          ...
          <div className="w-full md:w-1/2 mt-16 md:mt-0 relative">
            ...
            <Image src={logo} alt="Logo" width={500} height={500} className='w-full h-full object-cover' />
            {/* Decorative background behind the illustration */}
            {/* <div className="absolute inset-0 bg-gradient-to-tr from-primary-100 to-white rounded-3xl transform rotate-3 scale-105 opacity-50 z-0"></div> */}
            
            {/* <div className="relative z-10 bg-white rounded-3xl shadow-2xl shadow-primary-900/10 border border-gray-100 overflow-hidden flex flex-col h-[28rem] lg:h-[32rem] transform transition-transform hover:scale-[1.01] duration-500"> */}
              {/* Mockup Top Bar */}
              ...
              {/* <div className="flex-1 p-6 flex flex-col gap-6 bg-[#f8fafc]">
                <div className="flex justify-between items-end">
                  ...
                  <div className="h-10 w-32 bg-primary-600 rounded-lg shadow-md shadow-primary-200"></div>
                </div> */}
                ...
                {/* <div className="bg-white flex-1 rounded-xl shadow-sm border border-gray-100 p-4 flex flex-col gap-4">
                  ...
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="flex items-center gap-4 border-b border-gray-50 pb-3 last:border-0 last:pb-0">
                      ...
                      <div className="h-6 w-16 bg-primary-50 rounded-full"></div>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {/* Floating Badge */}
            {/* <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-2xl shadow-xl shadow-primary-900/10 border border-gray-100 flex items-center gap-4 z-20 animate-bounce" style={{ animationDuration: '3s' }}>
              <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center text-green-600">
                <ShieldCheck size={24} />
              </div>
              <div>
                <p className="text-sm font-bold text-slate-800">Secure Data</p>
                <p className="text-xs text-slate-500"> Data Privacy Act</p>
              </div>
            </div> */}
