...
const mockResidents: Resident[] = [
  { id: 1, name: 'Juan Dela Cruz', email: 'juan@email.com', age: 35, gender: 'Male', civilStatus: 'Married', voters: true, address: 'Blk 1 L2 Sampaloc IV', status: 'Active' },
  { id: 2, name: 'Maria Santos', email: 'maria@email.com', age: 28, gender: 'Female', civilStatus: 'Single', voters: true, address: 'Blk 2 L5 Sampaloc IV', status: 'Active' },
  { id: 3, name: 'Pedro Reyes', email: 'pedro@email.com', age: 42, gender: 'Male', civilStatus: 'Married', voters: false, address: 'Blk 3 L1 Sampaloc IV', status: 'Active' },
  { id: 4, name: 'Ana Garcia', email: 'ana@email.com', age: 31, gender: 'Female', civilStatus: 'Widowed', voters: true, address: 'Blk 1 L3 Sampaloc IV', status: 'Inactive' },
  { id: 5, name: 'Luis Mendoza', email: 'luis@email.com', age: 26, gender: 'Male', civilStatus: 'Single', voters: true, address: 'Blk 2 L4 Sampaloc IV', status: 'Active' },
  { id: 6, name: 'Rosa Lim', email: 'rosa@email.com', age: 38, gender: 'Female', civilStatus: 'Married', voters: true, address: 'Blk 3 L2 Sampaloc IV', status: 'Active' },
  { id: 7, name: 'Carlos Bautista', email: 'carlos@email.com', age: 45, gender: 'Male', civilStatus: 'Married', voters: false, address: 'Blk 1 L4 Sampaloc IV', status: 'Pending' },
  { id: 8, name: 'Elena Castro', email: 'elena@email.com', age: 29, gender: 'Female', civilStatus: 'Single', voters: true, address: 'Blk 2 L1 Sampaloc IV', status: 'Active' },
  { id: 9, name: 'Elena Castro', email: 'elena@email.com', age: 29, gender: 'Female', civilStatus: 'Single', voters: true, address: 'Blk 2 L1 Sampaloc IV', status: 'Active' },
  { id: 10, name: 'Elena Castro', email: 'elena@emasil.com', age: 29, gender: 'Female', civilStatus: 'Single', voters: true, address: 'Blk 2 L1 Sampaloc IV', status: 'Active' },
  { id: 11, name: 'Elena Castro', email: 'elena@emasil.com', age: 29, gender: 'Female', civilStatus: 'Single', voters: true, address: 'Blk 2 L1 Sampaloc IV', status: 'Active' },
]
              ...
              {paginatedResidents.length > 0 ? (
                paginatedResidents.map((resident) => (
                  <tr key={resident.id} className="border-b border-gray-100 hover:bg-slate-50 transition-colors">
                    <td className="px-6 py-4 text-sm font-medium text-slate-900">{resident.name}</td>
                    <td className="px-6 py-4 text-sm text-slate-600">{resident.email}</td>
                    <td className="px-6 py-4 text-sm text-slate-600">{resident.age}</td>
                    ...
                    <td className="px-6 py-4 text-sm">
                      <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${resident.voters ? 'bg-blue-50 text-blue-700 border border-blue-200' : 'bg-slate-50 text-slate-700 border border-slate-200'}`}>
                        {resident.voters ? 'Yes' : 'No'}
                      </span>
                    </td>
                    <td className="px-6 py-4 text-sm text-slate-600 max-w-xs truncate">{resident.address}</td>
                    <td className="px-6 py-4 text-sm">
                ...
                <tr>
                  <td colSpan={9} className="px-6 py-12 text-center">
                    <p className="text-slate-600 font-medium">No residents found</p>
                  </td>
                </tr>
              )}
            </tbody>
